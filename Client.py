...
class GameClient:
    ...
    def _draw_one_player(self, player, pos, is_me):
        ...
        box_color = (16, 39, 112) if is_current_turn else (40, 40, 40)
        ...
        if is_sb: self.screen.blit(self.font_small.render("SB", True, (135, 84, 128)),
    ...
    def draw_action_ui(self):
        ...
        self.screen.blit(raise_text_title,
                         raise_text_title.get_rect(centerx=raise_rect.centerx, y=raise_rect.y-7 + int(8 * self.scale_h)))
        self.screen.blit(raise_text_amount, raise_text_amount.get_rect(centerx=raise_rect.centerx,
                                                                       y=raise_rect.y-5 + int(30 * self.scale_h)))
